...
export default class Drag {
  ...
  _moveHandler(e) {
    if (this.moving && this.entity && this.entity.id) {
      ...
      this.entity.position = new Cesium.Cartesian3.fromRadians(c.longitude, c.latitude);
      // this.entity.id.position = new Cesium.CallbackProperty(function () {
      //   return new Cesium.ConstantPositionProperty (new Cesium.Cartesian3.fromRadians(c.longitude, c.latitude, cc.height))
      // }, false)
    }
  }
}
